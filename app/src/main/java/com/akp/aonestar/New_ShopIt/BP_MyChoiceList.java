...
public class BP_MyChoiceList extends AppCompatActivity {
...
//    ImageView details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_my_choice_list);
...
//                GameDetails_popup1("MY CHOICE BASIC-2");
//            }
//        });
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(BP_MyChoiceList.this)) {
                    ...
                    Toast.makeText(BP_MyChoiceList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
...
//    Consolation_200_ProductList
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(BP_MyChoiceList.this);
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MYCHOICEBASIC_TWO_PRODUCTList_NEW", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            title_tv.setText("* Choose two product(A-B-C-D) and avoid participating in the race. (" + Response.length() + " items) *");
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(BP_MyChoiceList.this, 1);
                        BP_MyChoiceList.TaskEarningAdapter customerListAdapter = new BP_MyChoiceList.TaskEarningAdapter(BP_MyChoiceList.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(BP_MyChoiceList.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BP_MyChoiceList.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_MyChoiceList.this);
        requestQueue.add(stringRequest);

    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<BP_MyChoiceList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public BP_MyChoiceList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_primebasic_product, viewGroup, false);
            BP_MyChoiceList.TaskEarningAdapter.VH viewHolder = new BP_MyChoiceList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull BP_MyChoiceList.TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(BP_MyChoiceList.this)
...
//                    listener.onItemDeselected(i);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(BP_MyChoiceList.this, bannerData));
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(BP_MyChoiceList.this);
...
*/
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(BP_MyChoiceList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(BP_MyChoiceList.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(BP_MyChoiceList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();                    }
        ...
        }, BP_MyChoiceList.this, call1, "", true);
    }
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(BP_MyChoiceList.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MainGameDetailsbyCat", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(BP_MyChoiceList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        }, new Response.ErrorListener() {
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(BP_MyChoiceList.this);
