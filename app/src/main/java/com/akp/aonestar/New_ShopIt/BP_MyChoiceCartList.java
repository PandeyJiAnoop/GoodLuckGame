...
public class BP_MyChoiceCartList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_my_choice_cart_list);
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(BP_MyChoiceCartList.this)) {
                    ...
                    Toast.makeText(BP_MyChoiceCartList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(BP_MyChoiceCartList.this);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            title_tv.setText("*Choose Two product and avoid participating in the race. (" + Response.length() + " items) *");
...
//                            hashlist.put("ExtraDiscount", jsonObject.getString("ExtraDiscount"));
                            ...
                            make_pay_btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    intent.putExtra("GameCategory","Basic");
...
//                            tvPayAbleAmmount.setText(final_payablemaount);
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(BP_MyChoiceCartList.this, 1);
                        BP_MyChoiceCartList.TaskEarningAdapter customerListAdapter = new BP_MyChoiceCartList.TaskEarningAdapter(BP_MyChoiceCartList.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
                        Toast.makeText(BP_MyChoiceCartList.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
//                        Toast.makeText(BP_MyChoiceCartList.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BP_MyChoiceCartList.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_MyChoiceCartList.this);
        requestQueue.add(stringRequest);

    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<BP_MyChoiceCartList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public BP_MyChoiceCartList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_primebasic_product, viewGroup, false);
            BP_MyChoiceCartList.TaskEarningAdapter.VH viewHolder = new BP_MyChoiceCartList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull BP_MyChoiceCartList.TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(BP_MyChoiceCartList.this)
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(BP_MyChoiceCartList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(BP_MyChoiceCartList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
