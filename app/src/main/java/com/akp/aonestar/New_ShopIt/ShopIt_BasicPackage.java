...
public class ShopIt_BasicPackage extends AppCompatActivity {
    LinearLayout ll;
    ...
    private ShopIt_BasicPackage.FriendsListAdapter pdfAdapTer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_it_basic_package);
        ...
        mp = MediaPlayer.create(ShopIt_BasicPackage.this, R.raw.akp_click);
...
//                 Toast.makeText(getApplicationContext(),""+response,Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        Toast.makeText(ShopIt_BasicPackage.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                        AlertDialog.Builder builder = new AlertDialog.Builder(ShopIt_BasicPackage.this);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog1.dismiss();
                Toast.makeText(ShopIt_BasicPackage.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ShopIt_BasicPackage.this);
...
//                 Toast.makeText(getApplicationContext(),""+response,Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Glide.with(ShopIt_BasicPackage.this).load(jsonObject.getString("BannerImg")).error(R.drawable.a_logo).into(dumy);
                        }
                    } else {
                        Toast.makeText(ShopIt_BasicPackage.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
    ...
    public void CategoryAPI() {
        final ProgressDialog progressDialog = new ProgressDialog(ShopIt_BasicPackage.this);
...
//                            title_tv.setText("External Link Report("+Response.length()+")");
                        ...
                        pdfAdapTer = new ShopIt_BasicPackage.FriendsListAdapter(getApplicationContext(), arrFriendsList);
                        rcvList.setLayoutManager(layoutManager);
                        rcvList.setAdapter(pdfAdapTer);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
                        Toast.makeText(ShopIt_BasicPackage.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
    ...
    public class FriendsListAdapter extends RecyclerView.Adapter<ShopIt_BasicPackage.FriendsList> {
        ...
        public ShopIt_BasicPackage.FriendsList onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ShopIt_BasicPackage.FriendsList(LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_catshopit, parent, false));
        }

        @SuppressLint("SetTextI18n")
        public void onBindViewHolder(final ShopIt_BasicPackage.FriendsList holder, final int position) {
            ...
            if (data.get(position).get("SubCatImg").equalsIgnoreCase("")) {
                ...
                Glide.with(ShopIt_BasicPackage.this).load(data.get(position).get("SubCatImg")).into(holder.imgb);
            }
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {   Log.d("res_id",data.get(position).get("PKID"));
                    mp.start();
                    if (data.get(position).get("PKID").equalsIgnoreCase("5")) {
                        Intent intent = new Intent(getApplicationContext(), BP_WelcomeBasicGift.class);
                        ...
                        Intent intent = new Intent(getApplicationContext(), BP_MyChoiceList.class);
                        startActivity(intent);
                    }
                    else if (data.get(position).get("PKID").equalsIgnoreCase("7")) {
                        Intent intent = new Intent(getApplicationContext(), BP_BasicTradeProductList.class);
                        startActivity(intent);
                    }
                    else if (data.get(position).get("PKID").equalsIgnoreCase("8")) {
                        Intent intent = new Intent(getApplicationContext(), BP_BasicSwingProduct.class);
                        startActivity(intent);
                    }
...
//                    }
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(ShopIt_BasicPackage.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
...
//        arrayList.clear();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "GoodLuck_GameDetailsbyCat", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {  Log.d("resdetails",response);
                progressDialog.dismiss();
                try {
                    JSONObject object = new JSONObject(response);
                    ...
                    Toast.makeText(ShopIt_BasicPackage.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        }, new Response.ErrorListener() {
...
//                Toast.makeText(ShopIt_BasicPackage.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ShopIt_BasicPackage.this);
