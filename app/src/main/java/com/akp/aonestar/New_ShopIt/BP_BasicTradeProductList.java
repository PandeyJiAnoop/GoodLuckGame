...
public class BP_BasicTradeProductList extends AppCompatActivity {
...
//    ImageView details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_basic_trade_product_list);
...
//            @Override
//            public void onClick(View v) {
//                GameDetails_popup1("BASIC TRADE PRODUCT");
//            }
//        });
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(BP_BasicTradeProductList.this)) {
                    ...
                    Toast.makeText(BP_BasicTradeProductList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(BP_BasicTradeProductList.this);
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BASICSWINGTRADING_TWO_PRODUCTList_NEW", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("BASICSWINGTRADING", "" + response);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            title_tv.setText("* Basic Trade Products Only Regular Customers can buy it after 9th Week(" + Response.length() + " items) *");
...
//                            hashlist.put("StockStatus", jsonObject.getString("StockStatus"));
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(BP_BasicTradeProductList.this, 1);
                        BP_BasicTradeProductList.TaskEarningAdapter customerListAdapter = new BP_BasicTradeProductList.TaskEarningAdapter(BP_BasicTradeProductList.this, arrayList1);
...
//                        Toast.makeText(PP_MyChoiceList.this, "No data found", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BP_BasicTradeProductList.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_BasicTradeProductList.this);
        requestQueue.add(stringRequest);

    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<BP_BasicTradeProductList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public BP_BasicTradeProductList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_primebasic_product, viewGroup, false);
            BP_BasicTradeProductList.TaskEarningAdapter.VH viewHolder = new BP_BasicTradeProductList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull BP_BasicTradeProductList.TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(BP_BasicTradeProductList.this)
...
//                            notifyItemChanged(i);
                                    SelectedProductAPI(arrayList.get(i).get("PlanCode"),"BasicTrading");
              ...
              /*      if (arrayList.get(i).get("StockStatus").equalsIgnoreCase("OutStock")){
                        ...
                        if (isChecked) {
                            if (selectedItems.size() < MAX_SELECTION_COUNT) {
                                ...
                                checkedItems.set(i, !currentState);
//                            notifyItemChanged(i);
                                SelectedProductAPI(arrayList.get(i).get("PlanCode"), "Basic");
//                        listener.onItemSelected(i);
                            } else {
                                // Uncheck the checkbox and show a message
                                buttonView.setChecked(false);
                                Toast.makeText(vh.itemView.getContext(), "Only two selection are allowed.", Toast.LENGTH_SHORT).show();
...
//                        listener.onItemSelected(i);
                            ...
                            Toast.makeText(vh.itemView.getContext(), "Only one selection are allowed.", Toast.LENGTH_SHORT).show();
//                        SelectedProductAPI();
                            Intent intent=new Intent(getApplicationContext(),BP_PrimeTradeCartList.class);
                            startActivity(intent);
                        }
                    } else {
                        selectedItems.remove(i);
//                    listener.onItemDeselected(i);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(BP_BasicTradeProductList.this, bannerData));
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(BP_BasicTradeProductList.this);
...
*/
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(BP_BasicTradeProductList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(BP_BasicTradeProductList.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(BP_BasicTradeProductList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
        ...
        }, BP_BasicTradeProductList.this, call1, "", true);
    }
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(BP_BasicTradeProductList.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MainGameDetailsbyCat", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(BP_BasicTradeProductList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        }, new Response.ErrorListener() {
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(BP_BasicTradeProductList.this);
