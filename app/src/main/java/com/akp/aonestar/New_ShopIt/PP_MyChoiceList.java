...
public class PP_MyChoiceList extends AppCompatActivity {
...
//    ImageView details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pp_my_choice_list);
...
//            @Override
//            public void onClick(View v) {
//                GameDetails_popup1("MY CHOICE PRIME-4");
//            }
//        });
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(PP_MyChoiceList.this)) {
                    ...
                    Toast.makeText(PP_MyChoiceList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
...
//    Consolation_200_ProductList
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(PP_MyChoiceList.this);
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MYCHOICEPRIMEFOUR_PRODUCTList_NEW", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            title_tv.setText("* Choose Four product (A-B-C-D) and avoid participating in the race. (" + Response.length() + " items) *");
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(PP_MyChoiceList.this, 1);
                        PP_MyChoiceList.TaskEarningAdapter customerListAdapter = new PP_MyChoiceList.TaskEarningAdapter(PP_MyChoiceList.this, arrayList1);
...
//                        Toast.makeText(PP_MyChoiceList.this, "No data found", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PP_MyChoiceList.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PP_MyChoiceList.this);
        requestQueue.add(stringRequest);

    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<PP_MyChoiceList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public PP_MyChoiceList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_primebasic_product, viewGroup, false);
            PP_MyChoiceList.TaskEarningAdapter.VH viewHolder = new PP_MyChoiceList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull PP_MyChoiceList.TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(PP_MyChoiceList.this)
            ...
            vh.checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (!UserId.equalsIgnoreCase("")
                        && !(arrayList.get(i).get("IsPlan").equalsIgnoreCase("0"))){
...
//                            notifyItemChanged(i);
                                    SelectedProductAPI(arrayList.get(i).get("PlanCode"),"Prime");
//                        listener.onItemSelected(i);
                                } else {
                                    // Uncheck the checkbox and show a message
                                    buttonView.setChecked(false);
                                    Toast.makeText(vh.itemView.getContext(), "Only Four selection are allowed.", Toast.LENGTH_SHORT).show();
//                        SelectedProductAPI();
                                    Intent intent=new Intent(getApplicationContext(),PP_MychoiceCartList.class);
...
//                    listener.onItemDeselected(i);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(PP_MyChoiceList.this, bannerData));
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(PP_MyChoiceList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (title_tv.getText().toString().equalsIgnoreCase("* Choose two product and avoid participating in the race. (1) *")) {
//                            Cancel.setVisibility(View.GONE);
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(PP_MyChoiceList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//End ProductDetailspopupdetails
    ...
    public void SelectedProductAPI(String ProductCode,String GameCategory) {
        String otp1 = new GlobalAppApis().ShoppitProduct_AddToCartPrimeBasic(UserId,ProductCode,GameCategory);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.ShoppitProduct_AddToCartAPI(otp1);
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(PP_MyChoiceList.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
        ...
        }, PP_MyChoiceList.this, call1, "", true);
    }
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(PP_MyChoiceList.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MainGameDetailsbyCat", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(PP_MyChoiceList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        }, new Response.ErrorListener() {
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(PP_MyChoiceList.this);
