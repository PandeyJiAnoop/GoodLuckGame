...
public class BP_WelcomeBasicGift extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_welcome_basic_gift);
    ...
    private void initViews() {
        progressDialog = new ProgressDialog(BP_WelcomeBasicGift.this);
        ...
        if (InternetConnection.checkConnection(getApplicationContext())) {
            ...
            DialogManager.openCheckInternetDialog(BP_WelcomeBasicGift.this);
        }
        ...
        details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GameDetails_popup1("WELCOME PRIME GIFT");
            }
        });
    }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.Shoppit_WelcomePrime_New, jsonObject, response -> {
            ...
            try {
                ...
                if (productCategoryModel.isStatus()) {
                    ...
                    Toast.makeText(BP_WelcomeBasicGift.this, "Record not found", Toast.LENGTH_SHORT).show();
                }
        ...
        public void onBindViewHolder(@NonNull AdaptorScratchProductList.MyScratchHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   /* Toast.makeText(BP_WelcomeBasicGift.this, ""+itemList.get(position).getProductName()+
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (Status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Toast.makeText(BP_WelcomeBasicGift.this, jsonObject2.getString("msg"), Toast.LENGTH_SHORT).show();
                        }
                    }else {
                        Toast.makeText(BP_WelcomeBasicGift.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }}
        }, BP_WelcomeBasicGift.this, call1, "", true);
    }
    @SuppressLint("SetTextI18n")
    private void openScratchDialogBox(String pcode, String productImg, String productName, String price) {
        alertDialog = new Dialog(BP_WelcomeBasicGift.this);
        ...
        marqueeText.setText("In This Way you will get scratched three times,after that it will not come,you have to take one of the three");

        TextView title_tv= alertDialog.findViewById(R.id.title_tv);
        title_tv.setText("WELCOME BASIC GIFT\nLOAD OF LUCK");
        ...
        Glide.with(BP_WelcomeBasicGift.this)
                .load(productImg)
                .placeholder(R.drawable.logo)
                .error(R.drawable.logo)
                .into(imgProduct);
    ...
    private void DirectPointAddPlaceOrder(String p_code, String IsWin) {
        JSONObject jsonObject = new JSONObject();
        Log.d("responseparam_basic", String.valueOf(jsonObject));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.Shoppit_WelcomeBasicAcceptorNot_New, jsonObject, response -> {
            try {
...
//                    Toast.makeText(this, "" + jsonObject1.getString("Msg"), Toast.LENGTH_SHORT).show();
    ...
    public class FriendsListAdapter extends RecyclerView.Adapter<BP_WelcomeBasicGift.FriendsList> {
        ...
        public BP_WelcomeBasicGift.FriendsList onCreateViewHolder(ViewGroup parent, int viewType) {
            return new BP_WelcomeBasicGift.FriendsList(LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_layoutamountchoose, parent, false));
        }

        @SuppressLint("SetTextI18n")
        public void onBindViewHolder(final BP_WelcomeBasicGift.FriendsList holder, int position) {
            ...
            if (selectedPosition1 == position) {
                ...
                holder.tvNum1.setTextColor(ContextCompat.getColor(BP_WelcomeBasicGift.this, R.color.white));
            } else {
                holder.linear1Selected.setBackgroundResource(R.drawable.back_blue_white);
                holder.tvNum1.setTextColor(ContextCompat.getColor(BP_WelcomeBasicGift.this, R.color.black));
            }
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(BP_WelcomeBasicGift.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
...
//        arrayList.clear();
        final ProgressDialog progressDialog = new ProgressDialog(BP_WelcomeBasicGift.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MainGameDetailsbyCat", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(BP_WelcomeBasicGift.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_WelcomeBasicGift.this);
        requestQueue.add(stringRequest);

        //Now we need an AlertDialog.Builder object
        AlertDialog.Builder builder1 = new AlertDialog.Builder(BP_WelcomeBasicGift.this);
