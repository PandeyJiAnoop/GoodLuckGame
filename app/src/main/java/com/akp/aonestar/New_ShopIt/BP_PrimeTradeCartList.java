...
public class BP_PrimeTradeCartList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_prime_trade_cart_list);
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(BP_PrimeTradeCartList.this)) {
                    ...
                    Toast.makeText(BP_PrimeTradeCartList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(BP_PrimeTradeCartList.this);
...
//                            hashlist.put("ExtraDiscount", jsonObject.getString("ExtraDiscount"));
                            ...
                            make_pay_btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    intent.putExtra("GameCategory","BasicTrading");
...
//                            final_payablemaount= String.valueOf(akp_txt_payableAmount);
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(BP_PrimeTradeCartList.this, 1);
                        BP_PrimeTradeCartList.TaskEarningAdapter customerListAdapter = new BP_PrimeTradeCartList.TaskEarningAdapter(BP_PrimeTradeCartList.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(BP_PrimeTradeCartList.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BP_PrimeTradeCartList.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("GameCategory", "BasicTrading");
                return params;
            }
        };
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_PrimeTradeCartList.this);
        requestQueue.add(stringRequest);
    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<BP_PrimeTradeCartList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public BP_PrimeTradeCartList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_primebasic_product_tradecart, viewGroup, false);
            BP_PrimeTradeCartList.TaskEarningAdapter.VH viewHolder = new BP_PrimeTradeCartList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull BP_PrimeTradeCartList.TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(BP_PrimeTradeCartList.this)
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(BP_PrimeTradeCartList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(BP_PrimeTradeCartList.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
