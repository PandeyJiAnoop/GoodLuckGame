...
import com.akp.aonestar.WalletActivity;
...
public class BP_BasicSwingProduct extends AppCompatActivity {
...
//    ImageView details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bp_basic_swing_product);
...
//                GameDetails_popup1("BASIC SWING TRADING");
//            }
//        });
...
//        auto refersh layout for gameId
    ...
    public void getBanner() {
        final ProgressDialog progressDialog = new ProgressDialog(BP_BasicSwingProduct.this);
        progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(BP_BasicSwingProduct.this, bannerData));
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(BP_BasicSwingProduct.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }}) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(BP_BasicSwingProduct.this);
    ...
    public void ProductListAPI() {
            ...
            public void onResponse(String response) { Log.d("GetProductTrading","sadaf"+response);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(BP_BasicSwingProduct.this, 1);
                        AllbetsListAdapter customerListAdapter = new AllbetsListAdapter(BP_BasicSwingProduct.this, all_bets_arrayList1);
        ...
        if (requestQueue1 == null) {
            requestQueue1 = Volley.newRequestQueue(BP_BasicSwingProduct.this);
    ...
    public class AllbetsListAdapter extends RecyclerView.Adapter<AllbetsListAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull AllbetsListAdapter.VH vh, int i) {
            ...
            Animation an = AnimationUtils.loadAnimation(BP_BasicSwingProduct.this, R.anim.blink);
...
//                Toast.makeText(getApplicationContext(),"Please Buy A Plan After That You Can Avail many Benefits!",Toast.LENGTH_SHORT).show();
    ...
    public void TradingProductBuyAPI(String buyrate,String procode) {
        ...
        if (requestQueuebuy == null) {
            requestQueuebuy = Volley.newRequestQueue(BP_BasicSwingProduct.this);
    ...
    public void TradingProductSellAPI(String sellrate,String procode,String rescode) {
        ...
        if (requestQueuesell == null) {
            requestQueuesell = Volley.newRequestQueue(BP_BasicSwingProduct.this);
    ...
    private void GameDetails_popup1(String getId1) {
        ...
        View dialogView = LayoutInflater.from(BP_BasicSwingProduct.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "MainGameDetailsbyCat", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(BP_BasicSwingProduct.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        }, new Response.ErrorListener() {
...
//                Toast.makeText(ShopIt_PrimePackageList.this, "No Record Found!", Toast.LENGTH_SHORT).show();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(BP_BasicSwingProduct.this);
