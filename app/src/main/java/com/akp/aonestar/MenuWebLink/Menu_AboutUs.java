...
public class Menu_AboutUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetTile=getIntent().getStringExtra("url");
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(Menu_AboutUs.this.getPackageManager()) != null) {
      ...
      /*  web = (WebView) findViewById(R.id.webview);
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                dialog = ProgressDialog.show(Menu_AboutUs.this, null, "Please Wait...");
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                // error page
                Toast.makeText(Menu_AboutUs.this, "The Requested Page Does Not Exist", Toast.LENGTH_LONG).show();
                web.loadUrl(GetUrl);
