...
import com.akp.aonestar.PriceDropModule.PriceDropApnaMart;
...
public class TossBossActivity extends AppCompatActivity implements View.OnClickListener {
    LinearLayout linearScratch, linearThreeOne, linearForTheWin, linearMatchGet;
    RecyclerView recyclerCategoryList, recyclerTossMatchAmt, recyclerTossMatchValue;
    ...
    LinearLayout linearHead, linearTell, linearTossPlay;
    TextView tvTossValue;
    Dialog alertDialog, alertDialog1;
    List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> itemList = new ArrayList<>();
    private int selectedPosition = -1;
    String selectedBitAmt = "", selectedBitAmtValue = "", coinValue = "", finalCoinValue = "";
...
CirclePageIndicator indicator;
    ...
    RecyclerView recyclerProductList, recyclerDisProductList1, recyclerDisProductList2, recyclerDisProductList3;
    ...
    RecyclerView recyclerTossMatchAmt1, recyclerTossMatchValue1;
    AdaptorMatchGetNum1 adaptorMatchGetNum1;
    AdaptorMatchGetNumValues1 adaptorMatchGetNumValues1;
    MediaPlayer mp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toss_boss);
        SharedPreferences sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId= sharedPreferences.getString("U_id", "");
        mp = MediaPlayer.create(TossBossActivity.this, R.raw.akp_click);
        ...
        LinearLayout FormetchandGet=findViewById(R.id.gamedetails_ll);
...
//                FormetchandGet_popup();
    ...
    private void initViews() {
       ...
       recyclerCategoryList = findViewById(R.id.recyclerCategoryList);
        recyclerTossMatchAmt = findViewById(R.id.recyclerTossMatchAmt);
        recyclerTossMatchValue = findViewById(R.id.recyclerTossMatchValue);
        linearHead = findViewById(R.id.linearHead);
        tvTossValue = findViewById(R.id.tvTossValue);
        linearTell = findViewById(R.id.linearTell);
        linearTossPlay = findViewById(R.id.linearTossPlay);
        close = findViewById(R.id.close);
        indicator = (CirclePageIndicator) findViewById(R.id.indicator);
        pager = (ViewPager) findViewById(R.id.pager1);
        linearHead.setOnClickListener(this);
        linearTell.setOnClickListener(this);
        linearTossPlay.setOnClickListener(this);
        ...
        recyclerTossMatchAmt1 = findViewById(R.id.recyclerTossMatchAmtwinner);
        recyclerTossMatchValue1 = findViewById(R.id.recyclerTossMatchValuelooser);
        recyclerTossMatchAmt1.setLayoutManager(new LinearLayoutManager(this));
        recyclerTossMatchAmt1.setHasFixedSize(true);
        recyclerTossMatchValue1.setLayoutManager(new LinearLayoutManager(this));
        recyclerTossMatchValue1.setHasFixedSize(true);
        ...
        if (InternetConnection.checkConnection(getApplicationContext())) {
            ...
            DialogManager.openCheckInternetDialog(TossBossActivity.this);
        }
    }

    private void getTossMatchAmt() {
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, WebServices.PLAYBUY_TossBossList, null, response -> {
            Log.d("PLAYBUY_TossBossList",""+response);

            Gson gson = new Gson();
            try {
                DataResTossMatchAmt getMatchNum = gson.fromJson(response.toString(), DataResTossMatchAmt.class);
                if (getMatchNum.isStatus()) {
                    itemList.clear();
                    itemList = getMatchNum.getResponse();
                    ...
                    adaptorMatchGetNumValues = new AdaptorMatchGetNumValues(getApplicationContext(), getMatchNum.getResponse());
...
/*
                    ...
                    Toast.makeText(TossBossActivity.this, "Record not found", Toast.LENGTH_SHORT).show();
                }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.linearHead:
                tvTossValue.setText("Head");
                coinValue = "1";
                linearHead.setBackgroundResource(R.drawable.back_selected_toss);
                linearTell.setBackgroundResource(R.drawable.back_unselected_toss);
                break;
            case R.id.linearTell:
                tvTossValue.setText("Tail");
                coinValue = "0";
                linearTell.setBackgroundResource(R.drawable.back_selected_toss);
                linearHead.setBackgroundResource(R.drawable.back_unselected_toss);
                break;

            case R.id.linearTossPlay:
                if (tvTossValue.getText().toString().trim().isEmpty()) {
                    Toast.makeText(this, "Please throw toss", Toast.LENGTH_SHORT).show();
                } else {
                    openPlayDialog();
                }
                break;
    ...
    private void GameDetails_popup(String getId) {
        ...
        View dialogView = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.popup_gameoverview, viewGroup, false);
...
//        arrayList.clear();
        final ProgressDialog progressDialog = new ProgressDialog(TossBossActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WebServices.PLAYBUY_GameDetailsbyCat, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(TossBossActivity.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TossBossActivity.this);
        requestQueue.add(stringRequest);

        //Now we need an AlertDialog.Builder object
        AlertDialog.Builder builder1 = new AlertDialog.Builder(TossBossActivity.this);
    ...
    private void openPlayDialog() {
        alertDialog = new Dialog(TossBossActivity.this);
        ...
        tvYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedBitAmt.isEmpty()) {
                    Toast.makeText(TossBossActivity.this, "Please select amount!", Toast.LENGTH_SHORT).show();
                } else {
                    alertDialog.dismiss();
                    AlertDialog.Builder builder = new AlertDialog.Builder(TossBossActivity.this,R.style.ThemeOverlay_MaterialComponents_MaterialAlertDialog_Background);
    ...
    private void getPlayAmtData(String selectedBitAmt) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.PLAYBUY_TossBossPlayNow, jsonObject, response -> {
            try {
                ...
                if (response.getBoolean("Status")) {
                    ...
                    Log.e("getMatchANdGet", "getMatchANdGet: " + jsonObject1.getInt("Coin"));
                    if (String.valueOf(jsonObject1.getInt("Coin")).equals(coinValue)) {
                        finalCoinValue = "1";
                    } else {
                        finalCoinValue = "0";
                    }
                    ...
                    //then we will inflate the custom alert dialog xml that we created
                    View dialogView11 = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.coinflip_popup, viewGroup11, false);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getTossBoss_Purchase(finalCoinValue);
                        }
                    }, SPLASH_TIME_OUT);


                    //Now we need an AlertDialog.Builder object
                    AlertDialog.Builder builder = new AlertDialog.Builder(TossBossActivity.this);
                    //setting the view of the builder to our custom view that we already inflated
    ...
    private void getTossBoss_Purchase(String finalCoinValue) {
        progressDialog.show();
        progressDialog.setMessage("Please wait...");
        progressDialog.setCancelable(false);
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("MatchCount", finalCoinValue);
            jsonObject.put("UserId", UserId);
            jsonObject.put("Amount", selectedBitAmt);
        } catch (JSONException e) {
            throw new RuntimeException(e);
        }
        Log.e("TAG", "getPlayAmtData1: " + jsonObject);

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.PLAYBUY_TossBoss_WinLose, jsonObject, response -> {
            try {
                Log.e("TAG", "getMatchANdGet1: " + response);
                if (response.getBoolean("Status")) {
                    progressDialog.dismiss();
                    JSONArray jsonArray = response.getJSONArray("Response");
                    JSONObject jsonObject1 = jsonArray.getJSONObject(0);
                    Toast.makeText(this, "" + jsonObject1.getString("Msg"), Toast.LENGTH_SHORT).show();
                    final MediaPlayer mp = MediaPlayer.create(TossBossActivity.this, R.raw.blast_one);
                    mp.start();
                    //before inflating the custom alert dialog layout, we will get the current activity viewgroup
                    ViewGroup viewGroup = findViewById(android.R.id.content);
                    //then we will inflate the custom alert dialog xml that we created
                    View dialogView = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.dynamic_winpopup, viewGroup, false);
                    ...
                    buy_btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.putExtra("class_name","tossboss");
                            startActivity(intent);
...
//                    });
                    ...
                    ViewGroup viewGroup = findViewById(android.R.id.content);
                    //then we will inflate the custom alert dialog xml that we created
                    View dialogView = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.dynamic_loosepopup, viewGroup, false);
                    Button rlBack = (AppCompatButton) dialogView.findViewById(R.id.btncancel);
                    TextView txt_msg = (TextView) dialogView.findViewById(R.id.txt_msg);
    ...
    public class AdaptorMatchGetNum extends RecyclerView.Adapter<AdaptorMatchGetNum.MyMatchHolder> {
        ...
        Context context;
        List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> matchList;

        public AdaptorMatchGetNum(Context context, List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> matchList) {
            this.context = context;
    ...
    public class AdaptorMatchGetNumValues extends RecyclerView.Adapter<AdaptorMatchGetNumValues.MyMatchValueHolder> {
        ...
        public AdaptorMatchGetNumValues(Context context, List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> matchList) {
            this.context = context;
            this.matchList = matchList;
        }
    ...
    public class AdaptorPopupSelectAmt extends RecyclerView.Adapter<AdaptorPopupSelectAmt.MyForWinAmt1Holder> {
        ...
        Context context;
        List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> list1;

        public AdaptorPopupSelectAmt(Context context, List<com.akp.aonestar.PlayBuyModule.PlayBuyModels.TossBossMatchAmt.ResponseItem> list) {
            this.context = context;
            this.list1 = list;
        }
...
/*    private void FormetchandGet_popup() {
        ...
        ViewGroup viewGroup = findViewById(android.R.id.content);
        //then we will inflate the custom alert dialog xml that we created
        View dialogView = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.popup_gameoverview_viewmore, viewGroup, false);
        FloatingActionButton close = dialogView.findViewById(R.id.close);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "PLAYBUY_Subcategory", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity.this, 3);
                    CategoryAdapter customerListAdapter = new CategoryAdapter(TossBossActivity.this, arrayList);
...
//                progressDialog.dismiss();
                Toast.makeText(TossBossActivity.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
...
//                         customerListAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity.this, 3);
                        customerListAdapter = new DashboardAdapter(TossBossActivity.this, arrayList1);
                        wallet_histroy.setLayoutManager(gridLayoutManager);
                        wallet_histroy.setAdapter(customerListAdapter);
                    } else {
                        txt_nodata.setVisibility(View.VISIBLE);
                        Toast.makeText(TossBossActivity.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull DashboardAdapter.VH vh, final int i) {
            ...
            Glide.with(TossBossActivity.this)
    ...
    private void openOfferpopup3(String productcode) {
        ...
        dialog = new Dialog(TossBossActivity.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                        Toast.makeText(TossBossActivity.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//End ProductDetailspopupdetails*/
    ...
    private void showProductDetails() {
        ...
        ViewGroup viewGroup = findViewById(android.R.id.content);
        //then we will inflate the custom alert dialog xml that we created
        View dialogView = LayoutInflater.from(TossBossActivity.this).inflate(R.layout.three_in_one_product_details, viewGroup, false);
        ...
        LinearLayout cat_one_ll = dialogView.findViewById(R.id.cat_one_ll);
        LinearLayout cat_two_ll = dialogView.findViewById(R.id.cat_two_ll);
        LinearLayout cat_three_ll = dialogView.findViewById(R.id.cat_three_ll);

        cat_one.setText("Rs. 10");
        cat_two.setText("Rs. 20");
        cat_three.setText("Rs. 50");
        cat_four.setText("Rs. 100");

        last_cat_ll.setVisibility(View.GONE);
//        cat_two_ll.setVisibility(View.GONE);
        cat_three_ll.setVisibility(View.GONE);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity .this, 1,GridLayoutManager.HORIZONTAL, false);
                        TossBossActivity.TaskEarningAdapter customerListAdapter = new TossBossActivity.TaskEarningAdapter(TossBossActivity.this, arrayList5);
    ...
    public class TaskEarningAdapter extends RecyclerView.Adapter<TossBossActivity.TaskEarningAdapter.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        ...
        @NonNull
        @Override
        public TossBossActivity.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product_threeinone, viewGroup, false);
            TossBossActivity.TaskEarningAdapter.VH viewHolder = new TossBossActivity.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull TossBossActivity.TaskEarningAdapter.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity .this, 1,GridLayoutManager.HORIZONTAL, false);
                        TossBossActivity.TaskEarningAdapter1 customerListAdapter = new TossBossActivity.TaskEarningAdapter1(TossBossActivity.this, arrayList6);
...
//                        Toast.makeText(TossBossActivity.this, "No data found", Toast.LENGTH_SHORT).show();
    ...
    public class TaskEarningAdapter1 extends RecyclerView.Adapter<TossBossActivity.TaskEarningAdapter1.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        ...
        @NonNull
        @Override
        public TossBossActivity.TaskEarningAdapter1.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product_threeinone, viewGroup, false);
            TossBossActivity.TaskEarningAdapter1.VH viewHolder = new TossBossActivity.TaskEarningAdapter1.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull TossBossActivity.TaskEarningAdapter1.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-"+arrayList.get(i).get("ProductCode"));
            vh.code.setText(arrayList.get(i).get("ProductName"));
            Glide.with(TossBossActivity.this)
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity .this, 1,GridLayoutManager.HORIZONTAL, false);
                        TossBossActivity.TaskEarningAdapter2 customerListAdapter = new TossBossActivity.TaskEarningAdapter2(TossBossActivity.this, arrayList7);
...
//                        Toast.makeText(TossBossActivity.this, "No data found", Toast.LENGTH_SHORT).show();
    ...
    public class TaskEarningAdapter2 extends RecyclerView.Adapter<TossBossActivity.TaskEarningAdapter2.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        ...
        @NonNull
        @Override
        public TossBossActivity.TaskEarningAdapter2.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product_threeinone, viewGroup, false);
            TossBossActivity.TaskEarningAdapter2.VH viewHolder = new TossBossActivity.TaskEarningAdapter2.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull TossBossActivity.TaskEarningAdapter2.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-"+arrayList.get(i).get("ProductCode"));
            vh.code.setText(arrayList.get(i).get("ProductName"));
            Glide.with(TossBossActivity.this)
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(TossBossActivity .this, 1,GridLayoutManager.HORIZONTAL, false);
                        TossBossActivity.TaskEarningAdapter3 customerListAdapter = new TossBossActivity.TaskEarningAdapter3(TossBossActivity.this, arrayList8);
...
//                        Toast.makeText(TossBossActivity.this, "No data found", Toast.LENGTH_SHORT).show();
    ...
    public class TaskEarningAdapter3 extends RecyclerView.Adapter<TossBossActivity.TaskEarningAdapter3.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        ...
        @NonNull
        @Override
        public TossBossActivity.TaskEarningAdapter3.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product_threeinone, viewGroup, false);
            TossBossActivity.TaskEarningAdapter3.VH viewHolder = new TossBossActivity.TaskEarningAdapter3.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull TossBossActivity.TaskEarningAdapter3.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-"+arrayList.get(i).get("ProductCode"));
            vh.code.setText(arrayList.get(i).get("ProductName"));
            Glide.with(TossBossActivity.this)
...
//                        JSONObject jsonObject1 = jsonObject.getJSONObject("data");
                    ...
                    pager.setAdapter(new AdapterForBanner(TossBossActivity.this, bannerData));
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        adaptorMatchGetNum1 = new AdaptorMatchGetNum1(getApplicationContext(), arrayListwin);
                        recyclerTossMatchAmt1.setAdapter(adaptorMatchGetNum1);
                        ...
                        final Runnable runnable = new Runnable() {
                            ...
                            @Override
                            public void run() {
                                if(wcount < adaptorMatchGetNum1.getItemCount()){
                                    if(wcount==adaptorMatchGetNum1.getItemCount()-1){
                                        wflag = false;
                                    }else if(wcount == 0){
                                        wflag = true;
                                    }
                                    ...
                                    recyclerTossMatchAmt1.smoothScrollToPosition(wcount);
                                    handler.postDelayed(this,speedScroll);
                                }
                            }
                        };
                        ...
                        final Runnable runnable1 = new Runnable() {
                            ...
                            @Override
                            public void run() {
                                if(wcount1 < adaptorMatchGetNumValues1.getItemCount()){
                                    if(wcount1==adaptorMatchGetNumValues1.getItemCount()-1){
                                        wflag1 = false;
                                    }else if(wcount1 == 0){
                                        wflag1 = true;
                                    }
                                    ...
                                    recyclerTossMatchValue1.smoothScrollToPosition(wcount1);
                                    handler1.postDelayed(this,speedScroll1);
                                }
                            }
                        };
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        adaptorMatchGetNumValues1 = new AdaptorMatchGetNumValues1(getApplicationContext(), arrayListloss);
                        recyclerTossMatchValue1.setAdapter(adaptorMatchGetNumValues1);
                        ...
                        final Runnable runnable = new Runnable() {
                            ...
                            @Override
                            public void run() {
                                if(count < adaptorMatchGetNum1.getItemCount()){
                                    if(count==adaptorMatchGetNum1.getItemCount()-1){
                                        flag = false;
                                    }else if(count == 0){
                                        flag = true;
                                    }
                                    ...
                                    recyclerTossMatchAmt1.smoothScrollToPosition(count);
                                    handler.postDelayed(this,speedScroll);
                                }
                            }
                        };
                        ...
                        final Runnable runnable1 = new Runnable() {
                            ...
                            @Override
                            public void run() {
                                if(count1 < adaptorMatchGetNumValues1.getItemCount()){
                                    if(count1==adaptorMatchGetNumValues1.getItemCount()-1){
                                        flag1 = false;
                                    }else if(count1 == 0){
                                        flag1 = true;
                                    }
                                    ...
                                    recyclerTossMatchValue1.smoothScrollToPosition(count1);
                                    handler1.postDelayed(this,speedScroll1);
                                }
                            }
                        };
...
//                        Toast.makeText(ThreeInOneActivity.this, "No data found", Toast.LENGTH_SHORT).show();
    ...
    public class AdaptorMatchGetNum1 extends RecyclerView.Adapter<AdaptorMatchGetNum1.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        public AdaptorMatchGetNum1(Context context, List<HashMap<String,String>> arrayList) {
            this.arrayList=arrayList;
            this.context=context;
        }
        ...
        @NonNull
        @Override
        public AdaptorMatchGetNum1.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.winner_top_layout, viewGroup, false);
            AdaptorMatchGetNum1.VH viewHolder = new AdaptorMatchGetNum1.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull AdaptorMatchGetNum1.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
    ...
    public class AdaptorMatchGetNumValues1 extends RecyclerView.Adapter<AdaptorMatchGetNumValues1.VH> {
        Context context;
        List<HashMap<String,String>> arrayList;
        public AdaptorMatchGetNumValues1(Context context, List<HashMap<String,String>> arrayList) {
            this.arrayList=arrayList;
            this.context=context;
        }
        ...
        @NonNull
        @Override
        public AdaptorMatchGetNumValues1.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.looser_top_layout, viewGroup, false);
            AdaptorMatchGetNumValues1.VH viewHolder = new AdaptorMatchGetNumValues1.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull AdaptorMatchGetNumValues1.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
