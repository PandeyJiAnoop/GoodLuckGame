...
public class PlayBuy_Oder_PersonalDetails extends AppCompatActivity {
    ...
    private String UserId,UserName,Getclass_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_buy__oder__personal_details);
        ...
        Add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (name_et.getText().toString().equalsIgnoreCase("")){
                    ...
                    intent.putExtra("playbuy_type","add");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.GOODLUCK_Seasonal_ScratchGetPlay_PurchaseAPI, jsonObject, response -> {
            try {
                ...
                if (response.getBoolean("Status")) {
                    ...
                    Intent intent=new Intent(PlayBuy_Oder_PersonalDetails.this, GoodLuckGameProductView.class);
                    startActivity(intent);
                } else {
    ...
    public void GetProfile() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+ "ProfileView", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PlayBuy_Oder_PersonalDetails.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PlayBuy_Oder_PersonalDetails.this);
