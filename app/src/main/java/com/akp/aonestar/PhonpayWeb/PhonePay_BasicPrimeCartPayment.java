...
public class PhonePay_BasicPrimeCartPayment extends AppCompatActivity {
    ...
    String UserId,GetTempOrderId,GetMob,GetAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_pay_basic_prime_cart_payment);
        SharedPreferences sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId= sharedPreferences.getString("U_id", "");
        GetTempOrderId=getIntent().getStringExtra("orderid");
        GetMob=getIntent().getStringExtra("mobile");
        GetAmount=getIntent().getStringExtra("amount");
        Integer intValue = Integer.valueOf((int) Math.round(Double.valueOf(GetAmount)));
        PayableAmt = String.valueOf(intValue);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(PhonePay_BasicPrimeCartPayment.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("https://aoneshop.co.in/UPIPAY/ShoppitPayment?UserId="+UserId+"&Amount="+PayableAmt
                    +"&OrderId="+GetTempOrderId +"&mobileNumber="+GetMob);
            Log.d("res","https://aoneshop.co.in/UPIPAY/ShoppitPayment?UserId="+UserId+"&Amount="+PayableAmt
                    +"&OrderId="+GetTempOrderId +"&mobileNumber="+GetMob);
        }
