...
public class PhonePay_AddWallet extends AppCompatActivity {
    ...
    String UserId,GetAmount,GetWalletType;
    RelativeLayout header;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phone_pay_add_wallet);
        SharedPreferences sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId= sharedPreferences.getString("U_id", "");
        GetAmount=getIntent().getStringExtra("amount");
        GetWalletType=getIntent().getStringExtra("type");
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(PhonePay_AddWallet.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("https://aoneshop.co.in/UPIPAY/FundRequest?UserId="+UserId+"&Amount="+GetAmount+"&WalletType="+GetWalletType);
        }
