...
public class E_ProductDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eproduct_details);
        findViewById();
        setListNer();
        ProductDetails();
        ProductDetailsVariationAPI("Size");
        ProductDetailsVariationAPI("Color");
...
//                        textView.setShowingChar(30);
                            ...
                            if (jsonObject.getString("ExdiscountAmt").equalsIgnoreCase("0.00")) {
                                llOne.setVisibility(View.GONE);
                            } else {
                                if (jsonObject.getString("Exdiscounttype").equalsIgnoreCase("Percentage")) {

                                    tv_extraOff.setText("\u20b9" + jsonObject.getString("discountAmt") + "%");

                                    llOne.setVisibility(View.VISIBLE);
                                } else {
                                    tv_extraOff.setText("\u20b9" + jsonObject.getString("discountAmt") + " Save");
                                    llOne.setVisibility(View.VISIBLE);
                                }
                            ...
                            if (jsonObject.getString("OfferType").equalsIgnoreCase("Percentage")) {
                                if (jsonObject.getString("SaleRate").equalsIgnoreCase(jsonObject.getString("ProductMRP"))) {
                                    ...
                                    tv_offer_price.setText(jsonObject.getString("ExdiscountAmt") + "%");
                                ...
                                if (jsonObject.getString("SaleRate").equalsIgnoreCase(jsonObject.getString("ProductMRP"))) {
                                    ...
                                    tv_product_price.setText("\u20b9" + jsonObject.getString("SaleRate"));
                                    tv_actual_price.setText("\u20b9" + jsonObject.getString("ProductMRP"));
                                    tv_offer_price.setText(jsonObject.getString("ExdiscountAmt") + " Save");
...
//                        Size Color Anoop Copy Below code--13-12-2023
                     ...
                     /*   JSONArray varcolor=jsonObject.getJSONArray("varcolor");
                        ...
                        if(varcolor.length()==0)
                        {
                            ...
                            layoutManager = new LinearLayoutManager(E_ProductDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false);
...
//                          layoutManager = new GridLayoutManager(getApplicationContext(),5);
                        ...
                        if(varsize.length()==0)
                        {
                            ...
                            layoutManager1 = new LinearLayoutManager(E_ProductDetailsActivity.this, LinearLayoutManager.HORIZONTAL, false);
...
*/
                        ...
                        Toast.makeText(E_ProductDetailsActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
        ...
        }, E_ProductDetailsActivity.this, call1, "", true);


    }


    public void ProductDetailsVariationAPI(String VarType) {
        String otp1 = new GlobalAppApis().ProductDetailsVariation(ProductCode,VarType);
        Log.v("otp1", otp1);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.ProductDetailsVar(otp1);
        new ConnectToRetrofit(new RetrofitCallBackListenar() {
            @Override
            public void RetrofitCallBackListenar(String result, String action) throws JSONException {
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    Log.v("ProductDetailsVar", result);
...
//                        JSONArray varsize=jsonObject1.getJSONArray("varsize");
//                        JSONArray varcolor=jsonObject1.getJSONArray("varcolor");
//                        JSONArray varsize=jsonObject1.getJSONArray("varsize");
                           /* if (jsonObject.getString("VariationType").equalsIgnoreCase("Color")) {
...
//                        onBackPressed();
    ...
    class DownloadFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(E_ProductDetailsActivity.this);
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (Status.equalsIgnoreCase("true")) {
                        Toast.makeText(E_ProductDetailsActivity.this, "Product added successfully!!!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), E_CartActivity.class));
                    } else {
                        Toast.makeText(E_ProductDetailsActivity.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                    }} catch (JSONException e) {
                    e.printStackTrace(); }
            }
        }, E_ProductDetailsActivity.this, call1, "", true);
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(E_ProductDetailsActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(E_ProductDetailsActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(E_ProductDetailsActivity.this, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(E_ProductDetailsActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
