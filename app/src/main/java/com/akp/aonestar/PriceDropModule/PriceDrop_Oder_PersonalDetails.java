...
public class PriceDrop_Oder_PersonalDetails extends AppCompatActivity {
    String GetproductCode,GetUserId,GetproductDisAmt,GetproductPrice,Getproductname,GetproductImage,GetProductDiscount,Getclass_name;
    AppCompatButton Add_button;
    private String UserId,UserName,GetColor,GetSize;
    EditText name_et,mob_et,email_et,address_et,pincode_et,street_et,loc_et;
    RelativeLayout header;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_price_drop__oder__personal_details);
        ...
        Add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (name_et.getText().toString().equalsIgnoreCase("")){
                    ...
                    intent.putExtra("pricedrop_type","add");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.GOODLUCK_Seasonal_ScratchGetPlay_PurchaseAPI, jsonObject, response -> {
            try {
                ...
                if (response.getBoolean("Status")) {
                    ...
                    Intent intent=new Intent(PriceDrop_Oder_PersonalDetails.this, GoodLuckGameProductView.class);
                    startActivity(intent);
                } else {
    ...
    public void GetProfile() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+ "ProfileView", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PriceDrop_Oder_PersonalDetails.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PriceDrop_Oder_PersonalDetails.this);
