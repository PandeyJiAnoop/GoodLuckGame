...
public class PriceDropFloatingButtonGameDetails extends RelativeLayout {
    ...
    public PriceDropFloatingButtonGameDetails(Context context) {
        super(context);
    }

    public PriceDropFloatingButtonGameDetails(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PriceDropFloatingButtonGameDetails(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void inflateHeader(String a_id) {
        ...
        inflater.inflate(R.layout.activity_price_drop_floating_button_game_details, this);
        ...
        fab_add_my_album_listing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (a_id.equalsIgnoreCase("PrizeDrop")){
...
//                Toast.makeText(getContext(),"Read Carefully Our Terms and Condition than Start your Purchasing.Thank You!!!"+a_id,Toast.LENGTH_LONG).show();
            }
        });
...
//        arrayList.clear();
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "PRIZEDROP_GameDetailsbyCat", new Response.Listener<String>() {
            @Override
