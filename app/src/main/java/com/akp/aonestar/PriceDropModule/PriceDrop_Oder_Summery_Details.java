...
public class PriceDrop_Oder_Summery_Details extends AppCompatActivity {
...
//            ProductColor.clear();
        ...
        rb_cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* new AlertDialog.Builder(PriceDrop_Oder_Summery_Details.this)
...
//                    startActivity(intent1);
            ...
            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                        ...
                        Intent intent=new Intent(getApplicationContext(), PriceDrop_Oder_PersonalDetails.class);
        ...
        if (Getclass_name.equalsIgnoreCase("trail_product")){
            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            public void onClick(View v) {   
                                ...
                                if (paymentmode.equalsIgnoreCase("Online")){
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        getProductDetailsTrail(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                    }
                                }
                                else {
                                    getProductDetailsTrail(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
        ...
        if (Getclass_name.equalsIgnoreCase("apnamart")){
            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            public void onClick(View v) {
                                if (paymentmode.equalsIgnoreCase("Online")){
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        getProductDetails(GetProductDiscount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                    }
                                }
                                else {
                                    getProductDetails(GetProductDiscount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
        ...
        if (Getclass_name.equalsIgnoreCase("productcontent")){
            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            public void onClick(View v) {   
                                ...
                                if (paymentmode.equalsIgnoreCase("Online")){
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        getProductDetailsproductcontent(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                    }
                                }
                                else {
                                    getProductDetailsproductcontent(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
    ...
    private void findViewId() {   extra_dis_tv=findViewById(R.id.extra_dis_tv);
        ...
        final ProgressDialog progressDialog = new ProgressDialog(PriceDrop_Oder_Summery_Details.this);
...
//                            }
                        ...
                        Glide.with(PriceDrop_Oder_Summery_Details.this)
...
//                        txt_payableAmount.setText(final_payablemaount);
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                        Toast.makeText(PriceDrop_Oder_Summery_Details.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(PriceDrop_Oder_Summery_Details.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PriceDrop_Oder_Summery_Details.this);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Glide.with(PriceDrop_Oder_Summery_Details.this).load(jsonObject2.getString("QRImg")).error(R.drawable.a_logo).into(image_qr);
                        }
                    } else {
                        Toast.makeText(PriceDrop_Oder_Summery_Details.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void getProductDetails(String p_dis,String p_price,String p_service,String p_del) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.PRIZEDROP_ApnaMart_Purchase, jsonObject, response -> {
            try {
                ...
                if (response.getBoolean("Status")) {
                    ...
                    Intent intent=new Intent(PriceDrop_Oder_Summery_Details.this, GoodLuckGameProductView.class);
                    startActivity(intent);
                } else {
    ...
    private void getProductDetailsproductcontent(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.PRIZEDROP_ProductContest_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
    ...
    private void getProductDetailsTrail(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.PRIZEDROP_TrailProduct_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://aoneshop.co.in/api/A1Shop/AllProductSizeList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    size_et.setAdapter(new ArrayAdapter<String>(PriceDrop_Oder_Summery_Details.this, android.R.layout.simple_spinner_dropdown_item, ProductSizeValue));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://aoneshop.co.in/api/A1Shop/AllProductColorList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    color_et.setAdapter(new ArrayAdapter<String>(PriceDrop_Oder_Summery_Details.this, android.R.layout.simple_spinner_dropdown_item, ProductColor));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
