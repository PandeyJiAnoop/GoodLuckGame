...
public class Oder_Summery_Details extends AppCompatActivity {
    Button btn_CreateOrder,btn_addtocart;
    String GetproductCode,GetUserId,GetProductDiscount;
    ImageView img,image_qr,ivBack;
    TextView name,code,amount,mrp,add_1,add_2,add_3,total_price_tv,dis_price_tv,service_tv,delivery_tv,txt_payableAmount,upiid_tv,extra_dis_tv;
    ...
    String UserId,Gettype,Getclass_name,GetColor,GetSize;  String PaymentMethod="Online",paymentmode="Wallet";
    LinearLayout qr_layout_ll;
    EditText utr_et;
    String final_payablemaount,discount,productMrp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oder__summery__details);
...
//        GetproductImage=getIntent().getStringExtra("p_img");
        ...
        Log.d("dadffas","adfdsfs"+GetColor+GetSize);

         findViewId();
         GETQRDetails();

         if (GetProductDiscount == null){
             extra_dis_tv.setVisibility(View.GONE);
         }
         else {
             extra_dis_tv.setVisibility(View.VISIBLE);
             extra_dis_tv.setText("Extra Discount:- "+GetProductDiscount+" %");
         }
...
//                    startActivity(intent1);
        ...
        rb_cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              /*  new AlertDialog.Builder(Oder_Summery_Details.this)
...
//                    startActivity(intent1);
        ...
        private void findViewId() {
            ...
            extra_dis_tv=findViewById(R.id.extra_dis_tv);
        ...
        txt_payableAmount=findViewById(R.id.txt_payableAmount);
            ...
            final ProgressDialog progressDialog = new ProgressDialog(Oder_Summery_Details.this);
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            productMrp = jsonObject2.getString("Mrp");
...
//                            }
                            ...
                            Glide.with(Oder_Summery_Details.this)
                            ...
                            if (GetProductDiscount == null){
                                ...
                                double akp_txt_payableAmount=Double.valueOf(saleRate)+Double.valueOf(serviceCharge)+Double.valueOf(deliveryCharge);
                                final_payablemaount= String.valueOf(akp_txt_payableAmount);
                                Double DiscountPercentage=((Double.parseDouble(final_payablemaount) *Double.parseDouble(GetProductDiscount)) /100);
                                Double finalorderamount=Double.parseDouble(final_payablemaount);
                                Double discountfinalpayment=finalorderamount - DiscountPercentage;
                                String lastamount=String.valueOf(discountfinalpayment);
                                txt_payableAmount.setText(lastamount);
                        ...
                        if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                            Toast.makeText(Oder_Summery_Details.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                            finish();
                        }
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.dismiss();
                    Toast.makeText(Oder_Summery_Details.this, "Something went wrong:-" + error, Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Oder_Summery_Details.this);
                ...
                btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            Intent intent=new Intent(getApplicationContext(),Oder_PersonalDetails.class);
...
//
            ...
            if (Getclass_name.equalsIgnoreCase("Consolation")){
//                payment_ll.setVisibility(View.GONE);
                            ...
                            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        if(!alreadyExecuted) {
                                            getProductDetailsConsolation(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
            ...
            if (Getclass_name.equalsIgnoreCase("Seasonal")){
                btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
            ...
            if (Getclass_name.equalsIgnoreCase("Freejoining")){
                btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        if(!alreadyExecuted) {
                                            getProductDetailsFreejoining(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                            alreadyExecuted = true;
                                        }
            ...
            if (Getclass_name.equalsIgnoreCase("Freetrail")){
                btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        if(!alreadyExecuted) {
                                            getProductDetailsFreetrailproduct(discount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                            alreadyExecuted = true;
                                        }
            ...
            if (Getclass_name.equalsIgnoreCase("Discount")){
                btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (add_3.getText().toString().equalsIgnoreCase("Pin Code:- null")){
                            ...
                            btn_CreateOrder.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if(utr_et.getText().toString().equalsIgnoreCase("")){
                                        ...
                                        if(!alreadyExecuted) {
                                            getProductDetailsDiscountproductDiscount(GetProductDiscount,productMrp,service_tv.getText().toString(),delivery_tv.getText().toString());
                                            alreadyExecuted = true;
                                        }
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Glide.with(Oder_Summery_Details.this).load(jsonObject2.getString("QRImg")).error(R.drawable.a_logo).into(image_qr);
                        }
                    } else {
                        Toast.makeText(Oder_Summery_Details.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.GOODLUCK_Seasonal_ScratchGetPlay_PurchaseAPI, jsonObject, response -> {
            try {
                ...
                if (response.getBoolean("Status")) {
                    ...
                    Intent intent=new Intent(Oder_Summery_Details.this, GoodLuckGameProductView.class);
                    startActivity(intent);
                } else {
    ...
    private void getProductDetailsFreejoining(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.FreeJoiningProduct_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
    ...
    private void getProductDetailsDiscountproduct(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
    ...
    private void getProductDetailsFreetrailproduct(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.FreeTrailProduct_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
    ...
    private void getProductDetailsDiscountproductDiscount(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.DiscountProduct_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
    ...
    private void getProductDetailsConsolation(String p_dis,String p_price,String p_service,String p_del) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("ProductCode", GetproductCode);
            jsonObject.put("UserId", UserId);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, WebServices.ConsolationProduct_Purchase, jsonObject, response -> {
            try {
                Log.e("TAG", "getPurchaseMessage: " + response);
                if (response.getBoolean("Status")) {
                    JSONArray jsonArray = response.getJSONArray("Response");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://aoneshop.co.in/api/A1Shop/AllProductSizeList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    size_et.setAdapter(new ArrayAdapter<String>(Oder_Summery_Details.this, android.R.layout.simple_spinner_dropdown_item, ProductSizeValue));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://aoneshop.co.in/api/A1Shop/AllProductColorList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    color_et.setAdapter(new ArrayAdapter<String>(Oder_Summery_Details.this, android.R.layout.simple_spinner_dropdown_item, ProductColor));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
