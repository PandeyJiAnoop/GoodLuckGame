package com.akp.aonestar.OrderTrack;
...
public class Web_OderDetailsTracking extends AppCompatActivity {
    ...
    String UserId,Getawb_number;
    RelativeLayout header;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_oder_details_tracking);
        SharedPreferences sharedPreferences = getSharedPreferences("login_preference",MODE_PRIVATE);
        UserId= sharedPreferences.getString("U_id", "");
        Getawb_number=getIntent().getStringExtra("awb_number");
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(Web_OderDetailsTracking.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("https://shiprocket.co/tracking/"+Getawb_number);        }
