...
public class FreeJoiningProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_joining_product);
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(FreeJoiningProduct.this)) {
                    ...
                    Toast.makeText(FreeJoiningProduct.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(FreeJoiningProduct.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(FreeJoiningProduct .this, 3);
                        TaskEarningAdapter customerListAdapter = new TaskEarningAdapter(FreeJoiningProduct.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(FreeJoiningProduct.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FreeJoiningProduct.this, "Something went wrong!"+error, Toast.LENGTH_SHORT).show();
            }
        }) {  @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FreeJoiningProduct.this);
    ...
    public class TaskEarningAdapter extends RecyclerView.Adapter<TaskEarningAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(FreeJoiningProduct.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(FreeJoiningProduct.this, bannerData));
    ...
    private void openOfferpopup() {
        ...
        dialog = new Dialog(FreeJoiningProduct.this);
        ...
        progressDialog.setMessage("Loading...");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"FreeJoiningProduct_Check", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Glide.with(FreeJoiningProduct.this).load(productImg).error(R.drawable.a_logo).into(imageView);
                    }

                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                        Toast.makeText(FreeJoiningProduct.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
        ...
        Okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             /*   final ProgressDialog progressDialog = new ProgressDialog(FreeJoiningProduct.this);
                progressDialog.setMessage("Loading...");
                progressDialog.show();
                StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"FreeJoiningProduct_Purchase", new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                JSONObject jsonObject2 = jsonArray.getJSONObject(i);
                        Toast.makeText(FreeJoiningProduct.this, jsonObject2.getString("Msg"), Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(FreeJoiningProduct.this, "Sorry!! You have Missed your Chance Try Again😭😭", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        Cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setMessage("Loading...");
                progressDialog.show();
                StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"FreeJoiningProduct_NoThanks", new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        try {
...
//                Toast.makeText(FreeJoiningProduct.this, "Successful😀😀😀😀", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    private void ProductDetailsPopup(String productcode) {
        //Create the Dialog here
        dialog1 = new Dialog(FreeJoiningProduct.this);
