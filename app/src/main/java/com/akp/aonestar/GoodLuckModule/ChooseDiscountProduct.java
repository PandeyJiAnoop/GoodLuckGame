...
public class ChooseDiscountProduct extends AppCompatActivity {
...
//    SwipeRefreshLayout srl_refresh;
    ...
    String planCode,plan_name,saleRate,productImg,discount;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choose_discount_product);
...
//                if (NetworkConnectionHelper.isOnline(ChooseDiscountProduct.this)) {
...
//                    }, 2000);
//                } else {
//                    Toast.makeText(ChooseDiscountProduct.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
        getHistory();
...
//        AdapterAkp adapter1 = new AdapterAkp(ChooseChooseDiscountProduct.this, images);
...
//        recyclerView.setAdapter(adapter1);
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(ChooseDiscountProduct.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(ChooseDiscountProduct .this, 3);
                        ChooseDiscountProduct.TaskEarningAdapter customerListAdapter = new ChooseDiscountProduct.TaskEarningAdapter(ChooseDiscountProduct.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(ChooseDiscountProduct.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ChooseDiscountProduct.this, "Something went wrong!"+error, Toast.LENGTH_SHORT).show();
            }
        }) {  @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ChooseDiscountProduct.this);
    ...
    public class TaskEarningAdapter extends RecyclerView.Adapter<ChooseDiscountProduct.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public ChooseDiscountProduct.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product, viewGroup, false);
            ChooseDiscountProduct.TaskEarningAdapter.VH viewHolder = new ChooseDiscountProduct.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull ChooseDiscountProduct.TaskEarningAdapter.VH vh, int i) {
            AnimationHelper.animatate(context,vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-"+arrayList.get(i).get("PlanCode"));
            vh.code.setText(arrayList.get(i).get("Plan_Name"));
            Glide.with(ChooseDiscountProduct.this)
                    .load(arrayList.get(i).get("ProductImg")).error(R.drawable.a_logo)
                    .into(vh.img);
            vh.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getamount=arrayList.get(i).get("SaleRate");
                    product_code.setText(arrayList.get(i).get("Plan_Name"));
                    product_name_tv.setText(arrayList.get(i).get("PlanCode"));
                    Glide.with(ChooseDiscountProduct.this)
                            .load(arrayList.get(i).get("ProductImg")).error(R.drawable.a_logo)
                            .into(product_img);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(ChooseDiscountProduct.this, bannerData));
    ...
    private void ProductDetailsPopup(String productcode) {
        ...
        dialog = new Dialog(ChooseDiscountProduct.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                        Toast.makeText(ChooseDiscountProduct.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//End ProductDetailspopupdetails
    ...
    public void PlayNowButtonAPI() {
        ...
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"DiscountPlayNow", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("sad","sc"+response);
                progressDialog.dismiss();
                String jsonString = response;
                try {
                    JSONObject object = new JSONObject(jsonString);
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            View dialogView = LayoutInflater.from(ChooseDiscountProduct.this).inflate(R.layout.congratulation, viewGroup, false);
                            ...
                            btncancel.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(ChooseDiscountProduct.this,R.style.ThemeOverlay_MaterialComponents_MaterialAlertDialog_Background);
...
//                                                    alertDialog6.dismiss();
                            ...
                            rlBack.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    intent.putExtra("class_name","Discount");
                                    startActivity(intent);
                                    dialog.dismiss();
                                }
                            });
                            //Now we need an AlertDialog.Builder object
                            AlertDialog.Builder builder = new AlertDialog.Builder(ChooseDiscountProduct.this);
                   ...
                   /*         //before inflating the custom alert dialog layout, we will get the current activity viewgroup
                            ...
                            //then we will inflate the custom alert dialog xml that we created
                            View dialogView11 = LayoutInflater.from(ChooseDiscountProduct.this).inflate(R.layout.discount_gift_popup, viewGroup11, false);
                        ...
                        Toast.makeText(ChooseDiscountProduct.this, object.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    private void ProceedToBuyAPI(String str_procode,String str_dis,String str_amount) {
        ...
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"DiscountProduct_Purchase", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                progressDialog.dismiss();
                String jsonString = response;
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            JSONObject jsonObject = Response.getJSONObject(i);
                            Toast.makeText(ChooseDiscountProduct.this, jsonObject.getString("Msg"), Toast.LENGTH_SHORT).show();
                            alertDialog5.dismiss();
                            Intent intent=new Intent(getApplicationContext(), GoodLuckGameProductView.class);
                            startActivity(intent);
                        }
...
//        offertv.setText(offer_dataArray.get(var).getDiscount()+"%");
        Glide.with(ChooseDiscountProduct.this)
                ...
                .into(img);
        View view = new View(ChooseDiscountProduct.this);
