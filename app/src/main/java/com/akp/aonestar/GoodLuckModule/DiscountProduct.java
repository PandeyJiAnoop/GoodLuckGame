...
public class DiscountProduct extends AppCompatActivity {
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(DiscountProduct.this)) {
                    ...
                    Toast.makeText(DiscountProduct.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(DiscountProduct.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(DiscountProduct .this, 3);
                        TaskEarningAdapter customerListAdapter = new TaskEarningAdapter(DiscountProduct.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(DiscountProduct.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DiscountProduct.this, "Something went wrong!"+error, Toast.LENGTH_SHORT).show();
            }
        }) {  @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DiscountProduct.this);
    ...
    public class TaskEarningAdapter extends RecyclerView.Adapter<TaskEarningAdapter.VH> {
        ...
        public void onBindViewHolder(@NonNull TaskEarningAdapter.VH vh, int i) {
            ...
            Glide.with(DiscountProduct.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl+"BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(DiscountProduct.this, bannerData));
    ...
    private void ProductDetailsPopup(String productcode) {
        ...
        dialog = new Dialog(DiscountProduct.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")){
                        Toast.makeText(DiscountProduct.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
