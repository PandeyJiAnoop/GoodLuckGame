package com.akp.aonestar.GoodLuckModule.NewTab;
...
public class NewUpdate_GoodLuckProductList extends AppCompatActivity {
    ...
    String GetUpdateId,GetUpdateName;
    TextView title_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_update_good_luck_product_list);
        GetUpdateId=getIntent().getStringExtra("update_id");
        GetUpdateName=getIntent().getStringExtra("update_name");
        ...
        title_tv.setText("*"+GetUpdateName+" View Products*");
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(NewUpdate_GoodLuckProductList.this)) {
                    ...
                    Toast.makeText(NewUpdate_GoodLuckProductList.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(NewUpdate_GoodLuckProductList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(NewUpdate_GoodLuckProductList .this, 3);
                        NewUpdate_GoodLuckProductList.TaskEarningAdapter customerListAdapter = new NewUpdate_GoodLuckProductList.TaskEarningAdapter(NewUpdate_GoodLuckProductList.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(NewUpdate_GoodLuckProductList.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(NewUpdate_GoodLuckProductList.this, "Something Went Wrong!"+error, Toast.LENGTH_SHORT).show();
            }
        }) {  @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(NewUpdate_GoodLuckProductList.this);
        requestQueue.add(stringRequest);
    }

    public class TaskEarningAdapter extends RecyclerView.Adapter<NewUpdate_GoodLuckProductList.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public NewUpdate_GoodLuckProductList.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product, viewGroup, false);
            NewUpdate_GoodLuckProductList.TaskEarningAdapter.VH viewHolder = new NewUpdate_GoodLuckProductList.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull NewUpdate_GoodLuckProductList.TaskEarningAdapter.VH vh, int i) {
            AnimationHelper.animatate(context, vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-"+arrayList.get(i).get("PlanCode"));
            vh.code.setText(arrayList.get(i).get("Plan_Name"));
            Glide.with(NewUpdate_GoodLuckProductList.this)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(NewUpdate_GoodLuckProductList.this, bannerData));
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(NewUpdate_GoodLuckProductList.this, "Something Went Wrong:-\n" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
    ...
    private void ProductDetailsPopup(String productcode) {
        ...
        dialog1 = new Dialog(NewUpdate_GoodLuckProductList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Glide.with(NewUpdate_GoodLuckProductList.this).load(productImg).error(R.drawable.a_logo).into(imageView);
