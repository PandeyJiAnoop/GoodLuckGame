...
public class ConsolationNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consolation_new);
...
//        *Baneer Code*
        ...
        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(ConsolationNew.this)) {
                    ...
                    Toast.makeText(ConsolationNew.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        getHistory();
    ...
    public void getHistory() {
        final ProgressDialog progressDialog = new ProgressDialog(ConsolationNew.this);
        progressDialog.setMessage("Loading");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "Consolation_200_ProductList", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            title_tv.setText("* Choose two product and avoid participating in the race. (" + Response.length() + ") *");
                        ...
                        GridLayoutManager gridLayoutManager = new GridLayoutManager(ConsolationNew.this, 3);
                        ConsolationNew.TaskEarningAdapter customerListAdapter = new ConsolationNew.TaskEarningAdapter(ConsolationNew.this, arrayList1);
                        cust_recyclerView.setLayoutManager(gridLayoutManager);
                        cust_recyclerView.setAdapter(customerListAdapter);
                    } else {
                        norecord_tv.setVisibility(View.VISIBLE);
//                        Toast.makeText(ConsolationNew.this, "No data found", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ConsolationNew.this, "Something went wrong!" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ConsolationNew.this);
        requestQueue.add(stringRequest);

    }


    public class TaskEarningAdapter extends RecyclerView.Adapter<ConsolationNew.TaskEarningAdapter.VH> {
        Context context;
        ...
        @NonNull
        @Override
        public ConsolationNew.TaskEarningAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(context).inflate(R.layout.dynamic_product_consolation, viewGroup, false);
            ConsolationNew.TaskEarningAdapter.VH viewHolder = new ConsolationNew.TaskEarningAdapter.VH(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull ConsolationNew.TaskEarningAdapter.VH vh, int i) {
            AnimationHelper.animatate(context, vh.itemView, R.anim.alfa_animation);
            vh.name.setText("Pro.Code-" + arrayList.get(i).get("PlanCode"));
            vh.code.setText(arrayList.get(i).get("Plan_Name"));

            Glide.with(ConsolationNew.this)
 ...
 /*           if (arrayList.get(i).get("SelectedProduct").equals("0")) {
            ...
            if (arrayList.get(i).get("IsSaved").equals("0")){
                btnSave.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SelectedProductAPI(arrRepaymentListt);
                    }
                });
            }
            else {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppUrls.baseUrl + "BannerList", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    pager.setAdapter(new AdapterForBanner(ConsolationNew.this, bannerData));
    ...
    private void openOfferpopup(String productcode, String selected) {
        ...
        dialog = new Dialog(ConsolationNew.this);
...
*/
                    ...
                    if (jsonObject.getString("Message").equalsIgnoreCase("You have already visited.")) {
                        Toast.makeText(ConsolationNew.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
//End ProductDetailspopupdetails
    ...
    public void SelectedProductAPI() {
        String otp1 = new GlobalAppApis().SavedAllTypeConsolationProduct_New(arrRepaymentListt, UserId, "7");
...
//                Toast.makeText(getApplicationContext(),""+result,Toast.LENGTH_LONG).show();
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("true")) {
                        ...
                        for (int i = 0; i < Response.length(); i++) {
                            ...
                            Toast.makeText(ConsolationNew.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(ConsolationNew.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                    }
        ...
        }, ConsolationNew.this, call1, "", true);
    }
}